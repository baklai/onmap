  ...
  <xsl:template match="/nmaprun">
    <html>
      <head>
        ...
        <xsl:comment>
          generated with nmap.xsl - version
  ...
  .unhidden { display: block; }
      ...
      <body>
        ...
        <div id="container">
          ...
          <p>
            Verbosity:
            <xsl:value-of select="verbose/@level" />
            ; Debug level
      ...
      <xsl:element name="table">
        ...
        <tr class="head">
          ...
          <td>
            ...
            <xsl:element name="a">
              <xsl:attribute name="href">
                javascript:togglePorts('porttable_
                <xsl:value-of select="$var_address" />
                ','closed');
              </xsl:attribute>
              <span class="noprint">
